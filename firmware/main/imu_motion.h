...
#define EH_SHAKE_THRESH    2.5f   /* g, peak accel */
#define EH_FLIP_THRESH     0.7f   /* cos(theta) vs gravity */
#define EH_TAP_MAX_G       1.8f
#define EH_STILL_TIMEOUT_MS 3000

void imu_motion_init(void);
void imu_motion_task(void *pvParameters);   /* esp_websocket_client_handle_t */
