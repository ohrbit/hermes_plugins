...
/* Global current mode (set by button task / gateway mode_ack). */
extern eh_mode_t s_mode;
...
/* ---------------------------------------------------------------------------
 * M5Stack Stick S3 (SKU K150) pin map — verified from m5-docs PinMap.
 * Display ST7789P3, IMU BMI270 (0x68), Audio ES8311 (0x18), buttons KEY1/KEY2.
 * ------------------------------------------------------------------------- */
#define EH_PIN_LCD_MOSI   39
#define EH_PIN_LCD_SCK    40
#define EH_PIN_LCD_RS     45   /* D/C */
#define EH_PIN_LCD_CS     41
#define EH_PIN_LCD_RST    21
#define EH_PIN_LCD_BL     38   /* backlight */
#define EH_PIN_IMU_SCL    48
#define EH_PIN_IMU_SDA    47
#define EH_PIN_IMU_INT    4    /* M5PM1 PYG4_IMU_INT (shared bus) */
#define EH_PIN_AUDIO_MCLK 18
#define EH_PIN_AUDIO_DOUT 14   /* ES8311 -> ESP (mic) */
#define EH_PIN_AUDIO_BCLK 17
#define EH_PIN_AUDIO_LRCK 15
#define EH_PIN_AUDIO_DIN  16   /* ESP -> ES8311 (speaker) */
#define EH_PIN_AUDIO_SCL  48   /* shared with IMU bus */
#define EH_PIN_AUDIO_SDA  47   /* shared with IMU bus */
#define EH_PIN_BTN_A      11   /* KEY1 (PTT) */
#define EH_PIN_BTN_B      12   /* KEY2 (mode toggle) */
#define EH_PIN_HY2_0      9    /* Port.A */
#define EH_PIN_HY2_1      10   /* Port.A */
#define EH_I2C_IMU_ADDR   0x68 /* BMI270 */
#define EH_I2C_AUDIO_ADDR 0x18 /* ES8311 */
#define EH_I2C_M5PM1_ADDR 0x6E /* power mgmt (shared bus) */

/* Default allowed pins for gateway IO tools (spec §8) — user GPIO only. */
#define EH_ALLOWED_PINS_DEFAULT { 9, 10, 38, 41, 45 }
#define EH_ALLOWED_PINS_COUNT   5
